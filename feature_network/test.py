...
sentences = word2vec.Text8Corpus("data/" + source_name)  # 加载语料
...
# 保存模型，以便重用
model.save("data/" + source_name + ".model")
# 对应的加载方式
# model_2 = word2vec.Word2Vec.load("text8.model")

# 以一种C语言可以解析的形式存储词向量
model.save_word2vec_format("data/" + source_name + ".model.bin", binary=True)
# 对应的加载方式
