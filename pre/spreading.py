...
def gen_new_features(kwlist, corpuslist, tfidf_models, index_list, iddict_list, k): # get top k features
...
if __name__ == '__main__':
    ...
    topk_dict = gen_new_features(kwlist, [wn_corpus, wiki_corpus], [wn_model, wiki_model], [wn_index, wiki_index], [wn_iddict, wiki_iddict], 10)
    print(topk_dict)
